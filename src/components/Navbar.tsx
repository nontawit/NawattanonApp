    ...
    <nav className="  bg-white p-1 shadow-md">
      ...
      {isMenuOpen && isMobile && (
        <ul className="md:hidden">
          <li className=' flex items-center justify-center'><Link href="/About" onClick={() => setMenuOpen(!isMenuOpen)} className="text-gray-600 pb-3 text-lg hover:text-gray-900 transition">เกี่ยวกับเรา</Link></li>
          <li className='flex items-center justify-center'><Link href="/Contact" onClick={() => setMenuOpen(!isMenuOpen)} className="text-gray-600 pb-3 text-lg hover:text-gray-900 transition">ติดต่อ</Link></li>
